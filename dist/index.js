...
var Form = function () {
  ...
  _createClass(Form, [{
    ...
    value: function post(url) {
      ...
      return this.request('post', url, { headers: headers });
    }
    ...
    value: function put(url) {
      ...
      return this.request('put', url, { headers: headers });
    }
    ...
    value: function patch(url) {
      ...
      return this.request('patch', url, { headers: headers });
    }
    ...
    key: 'transformData',
    value: function transformData(url, data, options) {
    ...
    value: function request(requestType, url) {
      ...
      if (['post', 'put', 'patch'].indexOf(requestType) !== -1) {
        requestData = this.transformData.apply(this, _toConsumableArray(requestData));
      }
    ...
    value: function requestSuccessHandler(resolve, response) {
    ...
    value: function requestErrorHandler(reject, error) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_ValidationMessage_vue__ = __webpack_require__(10);
...
var update = __webpack_require__(40)("5303d8a3", content, false, {});
...
// module
exports.push([module.i, "\n.help {\n  display: block;\n  font-size: 11px;\n  margin-top: 5px;\n}\n.help.is-danger {\n  color: #ff3860;\n}\n", "", {"version":3,"sources":["/Users/vasiliy/php/laravel-learning/resources/assets/js/mega-form/src/vuejs-form-plugin/src/components/src/components/ValidationMessage.vue"],"names":[],"mappings":";AAkCA;EACA,eAAA;EACA,gBAAA;EACA,gBAAA;CACA;AAEA;EACA,eAAA;CACA","file":"ValidationMessage.vue","sourcesContent":["<template>\n  <span class=\"help is-danger\" v-if=\"allErrors && allErrors.has(propertyName)\" v-text=\"allErrors.get(propertyName)\"></span>\n</template>\n\n<script>\n  export default {\n    props: {\n      errors: {\n        type: Object,\n        required: false,\n      },\n      propertyName: {\n        type: String,\n        required: true,\n      }\n    },\n    data() {\n      return {\n        injectedErrors: null,\n      }\n    },\n    computed: {\n      allErrors() {\n        if (this.errors) {\n          return this.errors;\n        }\n\n        return this.injectedErrors;\n      }\n    }\n  }\n</script>\n\n<style>\n  .help {\n    display: block;\n    font-size: 11px;\n    margin-top: 5px;\n  }\n\n  .help.is-danger {\n    color: #ff3860;\n  }\n</style>\n"],"sourceRoot":""}]);
